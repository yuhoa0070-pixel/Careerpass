...
const schoolsData = [
  ...
  {id:"iu",website:"https://www.iu.edu.kh",name:"International University (IU)",type:"private",province:"phnom-penh",tuition:1000,duration:5,careers:["healthcare"],programs:["វេជ្ជសាស្ត្រ","កុមារ","គិលានុបដ្ឋាក"],rating:"3.9",desc:"សាកលវិទ្យាល័យវេជ្ជសាស្ត្រឯកជននៅភ្នំពេញ ផ្ដល់សញ្ញាបត្របរិញ្ញាបត្រផ្នែកវេជ្ជសាស្ត្រ កុមារ និងគិលានុបដ្ឋាក រយៈពេល ៥ ឆ្នាំ។",scholarNote:"អាហារូបករណ៍ជាង ១៤០កន្លែង លើ ៨ជំនាញសំខាន់។ ជំនាញគិលានុបដ្ឋាក៖ អាហារូបករណ៍ពាក់កណ្ដាល ១៦កន្លែង។ រង្វាន់សម្រាប់និស្សិតបញ្ចប់មធ្យមសិក្សាថ្មីៗ។ សូមទាក់ទងការិយាល័យចុះឈ្មោះសម្រាប់តម្លៃពិតប្រាកដ។",faculties:["មហាវិទ្យាល័យវិទ្យាសាស្ត្រសុខាភិបាល — គិលានុបដ្ឋាក (Nursing), វេជ្ជសាស្ត្រ (Medicine/MD)","មហាវិទ្យាល័យបច្ចេកវិទ្យា និងធុរកិច្ច — បច្ចេកវិទ្យាព័ត៌មាន (IT), គ្រប់គ្រងធុរកិច្ច (Business Administration)"]},
